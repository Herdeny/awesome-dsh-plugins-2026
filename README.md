...
- [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) - DeepSeek Harness 官方主仓库，践行“一切皆插件”的扩展理念 (⭐221137)
...
- [RealSeaberry/AutoMCM-Pro](https://github.com/RealSeaberry/AutoMCM-Pro) - 全栈式自动数学建模竞赛 Skill：AI 自动驾驶、人类副驾，GitOps 流水线 + 强制代码自证，支持 Claude Code / Codex / opencode / DSH (⭐224)
- [dream-num/dsh-univer-office](https://github.com/dream-num/dsh-univer-office) - Univer 官方 Office 插件：表格、文档、幻灯片、画布与关系表合一运行时，支持多 Agent 协作与版本化变更 (⭐280)
...
- [1692775560/dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) - Mimir 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表与 GPU 服务器 SSH 任务编排 (⭐223)
- [shengsheng90/DSH-taskboard](https://github.com/shengsheng90/DSH-taskboard) - 原生本地任务看板插件：SQLite 项目、Agent 认领/复核与原生 Web UI，无 iframe、无第二会话运行时 (⭐327)
...
- [LayneChai/superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) - Superpowers 技能包移植到 DSH：TDD、调试、规划与协作技能 (⭐88)
- [skymecode/deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) - DSH 原生 VS Code 编码代理扩展：会话管理、流式 Markdown、斜杠命令与插件中心，零部署免 WebUI (⭐145)
...
- [dhicoc/dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) - 完整 reverse-skill（85 个 SKILL.md）DSH Cordis 插件：逆向工程、授权渗透测试与安全研究技能包 (⭐118)
- [sandbaseai/sandbase-skills](https://github.com/sandbaseai/sandbase-skills) - 88 个可安装开源 Agent Skills：研究、社交情报、营销与商业工作流，兼容 Codex / Claude Code / Cursor / Gemini CLI / DSH (⭐129)
...
- [qkycir-123/dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) - 把成功的 DeepSeek Harness 会话自动沉淀为可复用、可审查的 Agent Skill (⭐99)
...
- [FeatherHunter/dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) - MattSkillsDeck：让 mattpocock/skills 在 DSH 里化作一块看得见、派得动的任务板 (⭐50)
- [linhut/gongwen-skill](https://github.com/linhut/gongwen-skill) - 中文公文全流程处理工具：GB/T 9704 格式检查与修复、内容优化、模板生成、Markdown 转公文、事实核验，原生支持 DSH 技能系统 (⭐41)
- [PerryLink/dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) - 行业与公司研究领域包：方法论技能、产业链图谱、公开信源政策/新闻跟踪、公司研究卡片与可审计研究报告（仅研究，非投资建议） (⭐64)
...
- [MichengAI/dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) - 在 DSH 中统一加载并安全管理本机 Agent Skills (⭐34)
...
- [DCspirit-23/DSH-inspired-Code-Simplification-Skill](https://github.com/DCspirit-23/DSH-inspired-Code-Simplification-Skill) - 移植自 DSH 官方 dsh-find-simplifications 的 Codex 技能：找出并应用代码简化机会 (⭐28)
- [omdsh-dev/dsh-custom-tool](https://github.com/omdsh-dev/dsh-custom-tool) - Monaco 编辑器创建与管理沙箱化 JavaScript 工具：模型驱动的工具全生命周期 (⭐23)
- [Rianico/dsh-better-edit](https://github.com/Rianico/dsh-better-edit) - 哈希锚定的 read/edit/undo_last_edit 工具：防编辑错位，更省 token、成本更低 (⭐22)
- [Yourdaylight/stock_datasource](https://github.com/Yourdaylight/stock_datasource) - 基于 Tushare 的本地财经数据源：AI 原生多 Agent 金融分析，自适应生成 HTTP 接口与 MCP 调用，Skill 对接 DeepSeek Harness / OpenClaw，支持微信/QQ/飞书 IM 盯盘 (⭐184)
- [JingHao-Leon/dsh-alpha-desk](https://github.com/JingHao-Leon/dsh-alpha-desk) - Alpha Desk：合规优先的 AI 投资台技能包，把 Agent 会话变成多策略基金回测与研究台 (⭐39)
- [KelaoHu/dsh-lowtide](https://github.com/KelaoHu/dsh-lowtide) - 错峰任务委派插件：闲时把任务排好，让它们无人值守地在低峰时段跑完并交回报告，支持人工裁决，桌面端 + Web 端 (⭐157)
- [ExElectron/dsh-tool-hongtou](https://github.com/ExElectron/dsh-tool-hongtou) - 红头公文生成插件：两阶段解耦流水线（LLM 结构化提纲 + 确定性 Word 2003 XML 版式渲染）产出标准红头公文 (⭐27)
- [Smalldy/godot-bridge](https://github.com/Smalldy/godot-bridge) - Godot 4.x 游戏驱动插件：通过游戏内 TCP 交互服务器启动并操控运行中的 Godot 游戏，用原生 Agent 工具替代 godot-mcp (⭐26)
- [Zvyan/PromptForge](https://github.com/Zvyan/PromptForge) - 多平台提示词工程框架：9 大领域 56 个结构化模板、118 个预设，原生适配 DSH / Cursor / Claude / OpenAI，附 FastAPI Web UI 与 Typer CLI (⭐26)
...
- [zenstory-ai/oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) - 小说创作与短剧生产插件：由 Oh Story 与 Drama Skills 驱动的写作工作流 (⭐307)
- [shanliuling/dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) - 在 DSH 对话中直接生成图片 (⭐320)
- [zseven-w/dsh-openpencil](https://github.com/zseven-w/dsh-openpencil) - OpenPencil 预览、检查与编辑插件 (⭐153) 🛡️QC:64 🟡
- [devin-axis/deepseek-design](https://github.com/devin-axis/deepseek-design) - 可编辑设计系统，支持 AI 生成、可视化编辑、模板市场与 PPT (⭐785) 🛡️QC:17 🔴
- [kwhi6693-web/photo-abstract-editorial](https://github.com/kwhi6693-web/photo-abstract-editorial) - 照片转杂志编辑风 Skill：场景感知布局、创意控制与严格保真合成，含 Codex 原版与 V3 自适应版 (⭐97)
- [zhaiyateng/dsh-design-skills](https://github.com/zhaiyateng/dsh-design-skills) - 设计美学技能包：dark-saas / Apple 极简 / 新拟态 / 粗野主义 / 玻璃拟态 / 日式极简 6 种风格，让 Vibe Coding 网站告别「AI 味」 (⭐22)
- [LiPu-jpg/Openwrite](https://github.com/LiPu-jpg/Openwrite) - dsh-Openwrite：OpenWrite 的 DeepSeek Harness 小说创作插件，含统一创作 Agent、90 个小说工具、原生工作台与标准审稿 DAG (⭐691)
- [EthanYoQ/AI-Novel-Writer](https://github.com/EthanYoQ/AI-Novel-Writer) - AI 小说创作软件：把灵感、角色、世界观、大纲、章节写作、审稿与修稿组织成可控流程，提供 Windows/macOS 桌面版、Ollama 集成与 DSH 插件预览 (⭐806)
- [LaplaceYoung/dsh-directorx](https://github.com/LaplaceYoung/dsh-directorx) - DirectorX 的 DSH 插件版：AI 视频/图片/音频技能、知识语料库，以及可配置的视觉/图像/视频/音频模型工具 (⭐29)

<a id="vision"></a>

## 👁️ 视觉与多模态

- [liustack/modlens](https://github.com/liustack/modlens) - DSH 视觉桥接插件，为纯文本 Agent 提供视觉能力 (⭐3891) 🛡️QC:43 🟠
...
- [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) - 开放的侧边栏底座：支持三方扩展注册新侧边栏页面，内置文件渲染编辑/终端/Git/子代理页面 (⭐3376) 🛡️QC:51 🟡
...
- [liangmianya/dsh-synapse](https://github.com/liangmianya/dsh-synapse) - 可视化的非线性对话工作区：基于画布的会话探索与分支工作区 (⭐347)
- [Aisland-SJL/dsh-worktable](https://github.com/Aisland-SJL/dsh-worktable) - Agent 项目工作台：侧边栏应用抽屉 + 可停靠分屏工作区 + 实时监控所有项目的控制室 (⭐512)
...
- [Fishquito7/dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) - DSH Web UI 插件：Web 界面的 Skill 与 MCP 管理工具 (⭐117)
...
- [hsiangnianian/dsh-auto-continue](https://github.com/hsiangnianian/dsh-auto-continue) - 自动发送“继续”，恢复被中断的请求 (⭐69) 🛡️QC:72 🟢
...
- [plolpl789/dsh-raw-html-v2](https://github.com/plolpl789/dsh-raw-html-v2) - VCP 视觉联觉协议插件 v2（官方 Slot API）：raw-HTML vcp-root 卡片、流式渲染、KaTeX/Mermaid/SVG 与内置字体 (⭐24)
...
- [Jiyr0119/dsh-workspace-explorer](https://github.com/Jiyr0119/dsh-workspace-explorer) - 工作区文件资源管理器：右侧目录树面板，点击/拖拽文件引用进输入框，UI 对齐 DSH 原生风格 (⭐28)

<a id="themes-appearance"></a>

## 🎨 主题与外观

- [Small-tailqwq/dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) - 适用于 DeepSeek Harness 的鲸鱼娘系列皮肤 (⭐1944) 🛡️QC:25 🔴
...
- [elysia395/dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) - 把本机 Wallpaper Engine 壁纸变成 DSH 网页界面背景：Video 动态播放、Web 以 iframe 加载、Scene 壁纸静态帧 (⭐248)
...
- [RevolutionLA/dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) - 换肤/壁纸/主题包插件：8 套 Mirage 主题、每用户强调色、主题包导入导出与收藏 (⭐149) 🛡️QC:67 🟡
...
- [Tommy00748/dsh-theme-cyberpunk2077](https://github.com/Tommy00748/dsh-theme-cyberpunk2077) - Cyberpunk 2077 / 夜之城主题：CRT 扫描线、Kiroshi 锁定、打字机特效 (⭐28) 🛡️QC:61 🟡
...
- [ymh0000123/dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) - 终末地官网风格的 DSH Web 主题：奶油纸底、墨黑文字、信号黄强调、全直角工业编辑风 (⭐72)
...
- [niiang/dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) - 《你的名字。》新海诚风格 DSH Web GUI 主题 (⭐31)
...
- [NoNameLeGo/dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) - DSH Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 一键切换，内置可开关的玻璃质感 (⭐32)
- [yoli-mi/dsh-client-ui-custom](https://github.com/yoli-mi/dsh-client-ui-custom) - 可配置 DSH Web 界面插件：壁纸与磨砂玻璃主题、强调色、自定义快捷键、应用使用面板与历史条，零侵入式修改 (⭐27)
- [YRN-playmaker/dsh-wallpaper_share](https://github.com/YRN-playmaker/dsh-wallpaper_share) - 壁纸引擎同步插件：挂在 DSH 上一键同步壁纸引擎各类动态场景壁纸，可设置应用启动项 (⭐30)
- [webkubor/dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) - Bloom 莫兰迪配色主题插件：OKLCH 调色 9 变体、明暗双主题、顶栏一键切换，18 组配色实测全部达 WCAG AA (⭐31)
- [chouxiaohuai/dsh-uiskin-theme](https://github.com/chouxiaohuai/dsh-uiskin-theme) - 海洋幻想「蓝玻璃」主题：海洋背景、玻璃气泡、海洋侧边栏、鲸鱼设置按钮与炫彩模型文字，静态 profile 一键安装 (⭐23)
...
- [MeteorNOX/DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) - 住在 DSH 界面右下角的小鲸鱼娘余额监视器：拖拽吸附、数字滚动动画，随界面自动启用 (⭐1811)
- [V1ki/dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) - 把 ChatGPT (Codex)、Claude、Grok (X Premium) 订阅直接当作 DSH 的 LLM 提供商：Web UI 内 OAuth 登录，无需 API Key (⭐328)
- [Han-1413141/dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) - 会话成本计量插件：会话/每日花费、预算与历史记录 (⭐257)
- [Mars-Sea/dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) - 非官方 Command Code LLM 提供商插件：实时模型目录、推理档位支持与 Models 页卡片，移植自 pi-commandcode-provider (⭐163)
- [feibi-mochi/deepseek-harness-wallet](https://github.com/feibi-mochi/deepseek-harness-wallet) - 余额监控、会话级花费与 Token 追踪 (⭐65) 🛡️QC:58 🟡
- [franksong2702/dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) - ChatGPT OAuth 与 Codex 模型接入 (⭐89) 🛡️QC:68 🟡
...
- [BeforeWave/dsh-with-chatgpt](https://github.com/BeforeWave/dsh-with-chatgpt) - 把 ChatGPT 的推理能力带到本地代码库：直接工作，或把大型任务委派给 DSH (⭐47)
- [amlyczz/dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) - Google Antigravity (agy CLI) 模型桥接插件：多账号智能池化、流式对话/思考/工具活动/用量，界面内 Google OAuth 登录 (⭐42)
- [WSL043/dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) - 把 ChatGPT / Codex 订阅直接接入 DSH：OAuth 登录、模型、搜索、额度与图片生成，无需 API Key 或 Codex CLI (⭐44)
- [Axiaohungry/dsh-llm-workbuddy](https://github.com/Axiaohungry/dsh-llm-workbuddy) - 在 DSH 中使用 WorkBuddy API 作为 LLM 提供商（当公司只提供 WorkBuddy 积分时的选择） (⭐28)
- [kenz1117/dsh-ui-usage-billing](https://github.com/kenz1117/dsh-ui-usage-billing) - DSH 用量计费仪表盘插件：侧边栏成本指标、从会话日志聚合真实用量、内置多提供商价目表 (⭐35)
- [FishBottle7/opencode2dsh](https://github.com/FishBottle7/opencode2dsh) - 在 DSH 里直接使用 OpenCode Zen 免费模型：免费 LLM API，无需 API Key (⭐56)
- [ClapEcho233/dsh-cli-provider](https://github.com/ClapEcho233/dsh-cli-provider) - 把本机已登录的 Codex CLI 与 Claude Code 接入 DSH：复用订阅登录态、无需 API Key，支持模型发现、推理强度设置与工具调用适配 (⭐42)
...
- [win4r/deepseek-harness-plugin-creator](https://github.com/win4r/deepseek-harness-plugin-creator) - 可复用的 Codex Skill：构建并校验 DeepSeek Harness 与 Cordis 插件 (⭐35)
- [oxbshw/watch-skill](https://github.com/oxbshw/watch-skill) - 给 Agent「眼睛和耳朵」：把视频/音频/屏幕活动变成带时间戳、可搜索的证据，用确定性契约而非模型观点验证工具真实行为；DeepWatch 构建于 DeepSeek Harness 工作区，MCP/CLI/REST/Web 皆可 (⭐336)
- [sunxin-ai/dsh-design-qa](https://github.com/sunxin-ai/dsh-design-qa) - 设计保真度质检：给纯文本模型一双眼睛，判断实现是否与设计稿一致（附基准与评测） (⭐36)
- [PerryLink/dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) - 交付前双重校验纪律包：先拷问需求，再测试实现，最后自证交付 (⭐26)
- [liangdabiao/dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) - 插件开发 Skill：指导 Agent 从 0 到 1 开发、构建、安装、测试 DSH 插件，附一个已通过 Web 界面实测的天气插件作整包参考 (⭐23)

<a id="examples-templates"></a>

## 📦 示例与模板

- [bugmaker2/dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) - DeepSeek Harness 插件开发模板 (⭐108) 🛡️QC:66 🟡
...
- [THEWOLFWALKER/dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) - 统一通知推送插件：一个 notify() API，8 个渠道适配器（Telegram/钉钉/飞书/微信推送/Bark/Webhook 等），自动与手动双触发 (⭐88)
- [anionex/dsh-turn-rewind](https://github.com/anionex/dsh-turn-rewind) - 对话与代码状态回退插件，可重放历史回合 (⭐113) 🛡️QC:74 🟢
...
- [taxueseek/dsh-files](https://github.com/taxueseek/dsh-files) - 双面文件插件：会话隔离的文件上传（彩色 composer 卡片）+ read_document 工具（文本/PDF/DOCX/XLSX，内容嗅探与 LRU 缓存），原生图片直传视觉模型 (⭐33)
- [lsz-asd/dsh-plugin-session-delete](https://github.com/lsz-asd/dsh-plugin-session-delete) - 从 UI 删除 DSH 会话：头部危险按钮 + 侧栏会话菜单项，风险确认对话框、先停止运行中的 Agent、列表原地刷新 (⭐31)
- [Walvez/dsh-codex-sync](https://github.com/Walvez/dsh-codex-sync) - OpenAI Codex 与 DSH 的双向桥接：聊天双向同步、Skills 实时挂载与 MCP 自动镜像 (⭐25)
- [HongMing-Huang/dsh-file-upload](https://github.com/HongMing-Huang/dsh-file-upload) - 文件消息插件：Claude 风格拖拽/回形针上传、内容嗅探、MarkItDown 文档转 Markdown（含 JS 兜底）、文本内联与 read_document 工具 (⭐24)

<a id="just-for-fun"></a>

## 🎮 趣味

- [Minglink/dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) - DeepSeek 专用「无限三代」破甲插件：稳定化破甲提示词 (⭐1062)
- [Minglink/dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) - DeepSeek 专用「无限二代」插件：稳定化破甲提示词 (⭐1062)
- [yejiming/MuseAI](https://github.com/yejiming/MuseAI) - 创建 AI 角色、进入故事世界：聊天、冒险、穿书，支持 DeepSeek Harness 插件 (⭐590) 🛡️QC:38 🟠
- [hewzhew/dsh-agent-rp](https://github.com/hewzhew/dsh-agent-rp) - SillyTavern 迁移与新一代 DSH Agent 角色扮演插件 (⭐211)
...
- [Amakurai/dsh-liketavern](https://github.com/Amakurai/dsh-liketavern) - 把 dsh web 变成 SillyTavern 式角色扮演前端：角色卡/提示词预设/世界书/人设/BM25 长期记忆与楼层回滚，全挂宿主原生 slot 与 agent 运行时 (⭐39)
- [flizzywine/dsh-tavern](https://github.com/flizzywine/dsh-tavern) - 基于 DSH 的 SillyTavern 类文字游戏 Agent：候选项生成、对话式人物卡编辑、剧本模式与素材抽取 (⭐277)
...
- [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) - AgentTeams 插件：为 DeepSeek Harness 组建与管理多 Agent 团队 (⭐1413) 🛡️QC:64 🟡
- [Lum1104/dsh-browser](https://github.com/Lum1104/dsh-browser) - Chrome 侧边栏扩展，让 DSH 无需视觉能力即可直接操控浏览器 (⭐539) 🛡️QC:28 🔴
- [liustack/modsearch](https://github.com/liustack/modsearch) - DSH 网页搜索插件：全模式通用的搜索桥接能力 (⭐394)
...
- [ZSeven-W/dsh-crew](https://github.com/ZSeven-W/dsh-crew) - 从 Claude Code / Codex 向 DSH Agent 派发任务，原生子代理进度汇报 (⭐134) 🛡️QC:54 🟡
- [DDDMUC/dsh-free-search](https://github.com/DDDMUC/dsh-free-search) - 免费网页搜索提供商：DuckDuckGo 后端，无需 API Key (⭐136)
...
- [PKUfudawei/dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) - 统一能力菜单：按 Exposed / Progressive / Blocked 三档管理 MCP 工具与技能的能力暴露级别与执行模式 (⭐84)
- [PerryLink/dsh-mcp-panel](https://github.com/PerryLink/dsh-mcp-panel) - 官方 DSH MCP 客户端管理控制台：/mcp 命令带健康诊断与流水线试调用 (⭐50)
- [wp-a/nature-academic-search](https://github.com/wp-a/nature-academic-search) - 学术论文检索 Skill + MCP：面向中文科研用户，跨 CrossRef/PubMed/arXiv/OpenAlex/Europe PMC 检索去重，支持 MeSH、引用核验与引文图谱 (⭐196)
...
- [limuyang2/agent-team](https://github.com/limuyang2/agent-team) - 在 DSH 内组建多 Agent 团队：每位成员独立模型/技能/MCP 工具/上下文 + 共享工作区，支持 Leader 指派与独立会话 (⭐30)
- [EdgeTypE/dsh-better-deepseek](https://github.com/EdgeTypE/dsh-better-deepseek) - Better DeepSeek Chrome 扩展的 DSH 桥接插件：经 webServer 提供 HTTP 握手端点与会话级 SSE 事件流 (⭐28)
- [A3Boy/dsh-web-tools](https://github.com/A3Boy/dsh-web-tools) - 多提供商 Web 搜索与抓取插件：8 个深度适配的提供商、SearchHints、弹性回退，原生支持 X / 小红书检索 (⭐24)
- [988hj7tczd-oss/dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) - 跨平台 Computer Use 插件：隔离虚拟光标 + AX/UIA 可观测 + 截图视觉 + 12 个受防护工具的桌面自动化 (⭐26)
- [antibrow/dsh-antibrow](https://github.com/antibrow/dsh-antibrow) - 给 Agent 一个带持久身份的浏览器：引擎级指纹伪装、无限本地免费配置、Android 设备模拟、可长期存活的 passkey 与住宅代理出口 (⭐124)
...
- [csyangwen/dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) - 跨会话长期记忆 + 后台自我进化，五轨记忆 · git 分版本 (⭐286) 🛡️QC:31 🟠
- [ZSeven-W/dsh-noema](https://github.com/ZSeven-W/dsh-noema) - Noema 长期记忆插件：持久、可检视的 Agent 记忆，带召回工具与设置页 (⭐126) 🛡️QC:64 🟡
- [seriousz158/dsh-memory](https://github.com/seriousz158/dsh-memory) - 本地 Git 长期记忆插件：记忆存于本地 Git 仓库，设置页双确认清除，含空闲会话同步器与路径安全防护 (⭐184)
- [omdsh-dev/dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) - 跨 Agent、本地优先的持久记忆插件 (⭐341) 🛡️QC:59 🟡
- [PerryLink/dsh-memento](https://github.com/PerryLink/dsh-memento) - 有界、分层、审批门控、可审计的跨会话记忆 (⭐97) 🛡️QC:70 🟢
- [modusensus/dsh-mneme](https://github.com/modusensus/dsh-mneme) - 持久化、自动整合的记忆插件 (⭐85) 🛡️QC:17 🔴
- [aik358/dsh-auto-memory](https://github.com/aik358/dsh-auto-memory) - 三层自动记忆（用户级/项目笔记/每日日志）自动注入与检索 (⭐49) 🛡️QC:61 🟡
- [Phant0Meow/dsh-meow-memory](https://github.com/Phant0Meow/dsh-meow-memory) - 跨会话记忆插件：七层 SQLite 记忆库（灵魂/用户/项目/事实/课程/话题/规则）+ BM25 检索 (⭐82)
- [FuRongJun-1999/dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) - 白箱 AGI 架构探索：元认知、持续学习、世界模型、自我改进，零 LLM 白箱管线与可审计信任护栏 (⭐136)
- [Tyan66666/billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) - 模型驱动的上下文管理（Active Context Pruning / ACP）：由模型决定何时压缩什么，为 DSH 撑起超大上下文 (⭐75)
...
- [diqierjia/StrataGate-AgentMemory](https://github.com/diqierjia/StrataGate-AgentMemory) - 本地优先的 DSH 跨会话长期记忆：自动捕获、Event/Element 卡片、证据门控召回与来源溯源 (⭐39)
- [398894496-arch/DSH-KRouter](https://github.com/398894496-arch/DSH-KRouter) - 编码 Agent 的第二大脑：每日收尾沉淀进 Obsidian，次日即查；支持 Cursor / Codex / Claude Code / DeepSeek Harness (⭐37)
- [quqxui/dsh-memgas](https://github.com/quqxui/dsh-memgas) - 长期记忆插件：四通道检索融合 + 记忆演化闭环，记忆构建与检索方法来自 ICLR 2026 论文 MemGAS (⭐23)

<a id="security-audit"></a>

## 🔒 安全与审计

- [lire1131/dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) - DSH 崩溃救援插件：撤销配置与插件代码改动、密钥安全快照、一键 SAFE MODE；DSH 无法启动时也有离线 CLI/GUI (⭐147)
- [micromilo/upstream-radar](https://github.com/micromilo/upstream-radar) - DSH 插件安全与依赖监控 (⭐12) 🛡️QC:41 🟠
...
- [PerryLink/dsh-permission-rules](https://github.com/PerryLink/dsh-permission-rules) - Claude Code 风格声明式权限规则：有序 allow/deny/ask + 工具/参数/路径匹配，会话日志审计与热重载 (⭐113)
- [xiajiajun516/dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) - DSH 备份与恢复插件：导出/导入/迁移/同步完整配置、插件、MCP 服务器、技能与工作区，一键迁移到新机器 (⭐86)
...
- [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) - DSHDesktop：DeepSeek Harness 桌面版 (⭐5581)
- [DSH-EAC/DSH-Desktop-EAC](https://github.com/DSH-EAC/DSH-Desktop-EAC) - DSH Windows/Linux 桌面客户端：内置 Node.js 与完整 dsh CLI 内核，一键启动，10 款内置 UI 主题 (⭐1649) 🛡️QC:0 🔴
- [dsh-tauri-desk/deepseek-harness-desktop](https://github.com/dsh-tauri-desk/deepseek-harness-desktop) - DeepSeek Harness Tauri 桌面版：仅 5MB 安装包、零环境配置、预置插件，支持 Windows/macOS/Linux (⭐1735) 🛡️QC:38 🟠
- [vibeinging/dsh-desktop](https://github.com/vibeinging/dsh-desktop) - 本地 AI 桌面工作空间：DSH 会话、项目、文件、联网研究、插件与 Office 文档 (⭐631) 🛡️QC:18 🔴
- [op7418/pilot-harness](https://github.com/op7418/pilot-harness) - CodePilot 风格桌面客户端与插件套件：为 DeepSeek Harness 打造，支持 macOS/Windows/Linux (⭐270)
- [lencx/Minke](https://github.com/lencx/Minke) - 🐳 DeepSeek Harness 桌面客户端 (⭐622) 🛡️QC:28 🔴
- [omdsh-dev/dsh-genui](https://github.com/omdsh-dev/dsh-genui) - GenUI：交互式 UI 组件渲染 (⭐384) 🛡️QC:52 🟡
- [QCYTSN/dsh-dafeiyu](https://github.com/QCYTSN/dsh-dafeiyu) - 桌面原生大鱼（BigFish）陪伴应用：实时显示 Agent 状态，Windows 置顶常驻 (⭐301)
- [whitelonng/dshcode](https://github.com/whitelonng/dshcode) - 社区桌面伴侣：macOS/Windows 一键启动的 Electron 应用 (⭐712)
...
- [ningbainb/deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) - Windows 桌面客户端：零配置安装，内置 Codex/插件/技能/SSH 远程访问与 11 款皮肤 (⭐377) 🛡️QC:11 🔴
- [DSH-APP/DSHA](https://github.com/DSH-APP/DSHA) - 安卓启动器：内置 proot+Ubuntu，免 ROOT 免 Termux 一键运行 DeepSeek Harness (⭐452) 🛡️QC:25 🔴
- [WEP-56/DSH-Launcher](https://github.com/WEP-56/DSH-Launcher) - webui 内嵌式启动器：包管理/配置管理/插件管理，兼容所有 webui 强化插件 (⭐31) 🛡️QC:33 🟠
- [liguobao/ds-harness-remote](https://github.com/liguobao/ds-harness-remote) - 基于 DSH 插件机制的多端远程访问方案：桌面端与 Android 端安全连接并操作远程 Harness (⭐168)
...
- [Clarklevis1995/dsh-mobile](https://github.com/Clarklevis1995/dsh-mobile) - DeepSeek Harness 原生 iOS 客户端：通过 dsh-plugin-mobile-gateway 以 WebSocket 连接 Harness，把工作区、会话与 Agent 执行轨迹带到 iPhone (⭐192)
- [flymysql/dsh-remote](https://github.com/flymysql/dsh-remote) - DSH 远程工作助手：SSH（密钥或密码）连接远端工作区，rw_* 工具操作，SFTP 镜像到本地 DSH 工作区 (⭐59)
...
- [dclichang2022/dsh-green-meter](https://github.com/dclichang2022/dsh-green-meter) - 能耗/碳排实时控制台桌面应用：测量本地 GPU 推理、按公开系数估算云端 API 调用，并对浪费行为告警 (⭐101)
- [sagirimo/BioDSH](https://github.com/sagirimo/BioDSH) - 面向临床医生与湿实验科学家的生物信息学 Agent 桌面端：基于 DSH 构建，一键安装包、技能商店与离线模式 (⭐31)

<a id="platforms-channels"></a>

## 🌐 平台与渠道

- [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) - DSH 内置可视化插件市场：浏览、搜索、一键安装 (⭐3308) 🛡️QC:64 🟡
...
- [walkinglabs/awesome-deepseek-harness-plugins](https://github.com/walkinglabs/awesome-deepseek-harness-plugins) - 经过验证的 DeepSeek Harness 插件双语目录 (⭐20) 🛡️QC:25 🔴
...
- [runzhliu/deepseek-harness-docker](https://github.com/runzhliu/deepseek-harness-docker) - 社区 Docker/Kubernetes 打包：加固镜像、Compose 栈、Helm Chart、Web UI 与 headless CLI 一键部署 (⭐65)
...
- [techysy/deepseek-harness-fnos](https://github.com/techysy/deepseek-harness-fnos) - DeepSeek Harness fnOS 应用：NAS 本地常驻服务，一键部署官方 Agent 浏览器 UI (⭐30)
- [PGZXB/dsh-feishu](https://github.com/PGZXB/dsh-feishu) - DeepSeek Harness 的飞书 UI：面板驱动控制台，斜杠命令变卡片按钮、卡内审批与提问、流式卡片，扫码一键配置 (⭐26)
- [pax-beehive/dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) - DSH Plugin Hub 开源 CLI：schema、解析器与 DSH agent 工具，打通插件中心 (⭐235)
...
- [LivXue/dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) - 覆盖面最广的 DSH 插件市场：每日刷新、全网抓取，发布前逐个人工复核 (⭐703)
- [Tencent/skillhub](https://github.com/Tencent/skillhub) - 腾讯 SkillHub 开放 API 文档、示例与 DSH 插件 (⭐26)
...
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) - 为 DSH 插件生态打造的现代化桌面端解决方案 (⭐25855)
- [crafter-station/petdex](https://github.com/crafter-station/petdex) - Codex、Claude Code、DSH 等平台的动画宠物画廊 (⭐3842)
- [devin-axis/ipollowork](https://github.com/devin-axis/ipollowork) - 集成自进化 Agent 运行时的下一代 AI 工作空间 (⭐5857)
...
- [nexu-io/open-design](https://github.com/nexu-io/open-design) - 开源 Claude Design 替代方案，提供 DSH 设计能力 (⭐95698)
...
- [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) - DSH Web UI 的插件与皮肤合集 (⭐7449)
...
- [firstintent/ccteam](https://github.com/firstintent/ccteam) - 多 Agent 编排：把 Claude Code / Codex / Grok / Kimi / DeepSeek Harness 组成一个团队，任意会话派发与回收任务 (⭐418)
...
- [sandbaseai/deepseek-harness-handbook](https://github.com/sandbaseai/deepseek-harness-handbook) - Agent 优先的 DeepSeek Harness 深度手册：运行时、插件、MCP、沙箱、评测与故障排查（多语言） (⭐152)
...
- [huiliyi37/Tianshu-harness](https://github.com/huiliyi37/Tianshu-harness) - 天枢 (Tianshu)：基于 harness 工程的终端编程智能体运行时（TUI × GUI），针对 DeepSeek V4 做前缀缓存工程优化（长会话稳态命中率 97–99%），以认知虚拟机与信息素自衰减记忆构建 (⭐683)
- [zechen666-creater/deepseek-harness-oneclick-pack](https://github.com/zechen666-creater/deepseek-harness-oneclick-pack) - DSH 保姆级中文安装教程 + 开箱即用免安装版：小白从零上手，国内免梯子、全配镜像源 (⭐24)
